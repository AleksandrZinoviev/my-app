...
let postArray = [
  ...
  {id: 2, message: "Hi, how are you?", like: 20},
  {id: 3, message: "It`s my first post.", like: 60}
]
...
ReactDOM.render(
  <React.StrictMode>
    <App postArray={postArray} dialogsListArray={dialogsListArray} messagesListArray={messagesListArray}/>
  </React.StrictMode>,
